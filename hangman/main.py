...
while current_incorrect_guesses < num_of_incorrect_guesses and False in answer_guessed:
    # Display game status.
    print(f"Number of incorrct guesse remaining: {num_of_incorrect_guesses - current_incorrect_guesses}")

    print("Letters guessed: ", end = "")

    for current_letter_guess in letters_guessed:
        print(current_letter_guess, end = " ")
